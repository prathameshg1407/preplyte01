...
import type { ResumeProfileData, TemplateType, GenerateResumeOptions, ResumeSection } from '@/types/resume-builder.types';
import { 
...
export default function TemplateSelectionPage() {
  ...
  const [customization, setCustomization] = useState<Omit<GenerateResumeOptions, 'template' | 'profileData'>>({
    primaryColor: '#2b6cb0',
    fontFamily: 'Helvetica',
    sectionsOrder: ['summary', 'experience', 'education', 'skills', 'projects', 'certifications'] as ResumeSection[],
  ...
  // Memoize generatePreview to avoid recreating on every render
  ...
  useEffect(() => {
    if (profileData && selectedTemplate) {
      // Debounce preview generation
      const timeoutId = setTimeout(() => {
        generatePreview();
      }, 500); // Wait 500ms after last change before regenerating
