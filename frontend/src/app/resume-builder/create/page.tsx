...
import { saveResumeData } from '@/lib/api/resume-builder.client';
...
export default function CreateResumePage() {
  ...
  const { register, control, watch, setValue, formState: { errors } } = useForm<ResumeProfileData>({
    defaultValues: {
      fullName: '',
      email: '',
      phone: '',
  ...
  const handlePreview = () => {
    if (!formData.fullName || !formData.email || !formData.phone) {
      toast.error('Please fill in Name, Email, and Phone to preview');
      return;
    }
    setShowPreview(true);
  };
  ...
  const handleSaveAndContinue = () => {
    if (!formData.fullName || !formData.email || !formData.phone) {
      toast.error('Please fill in required fields (Name, Email, and Phone)');
      return;
    }
  ...
  const onSave = async () => {
    ...
    try {
      ...
      // Redirect to template selection with resume ID
      router.push(`/resume-builder/templates/${saved.id}`);
    } catch (error: any) {
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Enter the information for this resume. You can create resumes for anyone!
          </p>
        </div>
              ...
              <CardContent className="space-y-4">
                ...
                {educationFields.length === 0 && (
                  <div className="text-center py-12 border-2 border-dashed rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">Click "Add Education" to start</p>
                  </div>
                )}
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                ...
                {experienceFields.length === 0 && (
                  <div className="text-center py-12 border-2 border-dashed rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">Click "Add Experience" to start</p>
                  </div>
                )}
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                ...
                {projectFields.length === 0 && (
                  <div className="text-center py-12 border-2 border-dashed rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">Click "Add Project" to start</p>
                  </div>
                )}
              </CardContent>
            </Card>
      ...
      <Dialog open={showSaveDialog} onOpenChange={setShowSaveDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Give this resume a title so you can easily find it later.
            </DialogDescription>
          </DialogHeader>
          <div className="py-4">
            ...
            <Input
              ...
              placeholder="e.g., Software Engineer Resume, John's Resume"
              className="mt-2"
              autoFocus
              onKeyDown={(e) => {
                if (e.key === 'Enter' && resumeTitle.trim() && !isSaving) {
                  onSave();
                }
              }}
            />
          ...
          <DialogFooter>
            ...
            <Button onClick={onSave} disabled={isSaving || !resumeTitle.trim()}>
